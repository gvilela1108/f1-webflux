...
public class RestErrorHandler {
    ...
    public final ErrorDetail handleBusinessException(
            final BusinessException exception) {
        log.info(
                "m=handleBusinessException error={} requestDescription={}",
    ...
    @ResponseStatus(UNPROCESSABLE_ENTITY)
    public final ErrorDetail handleValidationException(
            final ValidationException exception) {
        log.debug(
                "m=handleValidationException error={} requestDescription={}",
                exception.getMessage());
        return new ErrorDetail(exception.getErrorCode());
    }
    ...
    public final ErrorDetail handleInternalException(
    ...
    public final ErrorDetail handleNotFoundException(
            final NotFoundException exception) {
        log.info(
                "m=handleNotFoundException status=error exception={} request={}",
                exception.getMessage());
        return new ErrorDetail(exception.getErrorCode());
    }
