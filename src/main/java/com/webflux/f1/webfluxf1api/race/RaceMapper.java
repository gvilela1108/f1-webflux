...
import com.webflux.f1.webfluxf1api.client.feign.response.RaceTable;
...
public interface RaceMapper {
  ...
  default Races fromEntityToResponse(
      Race race, CircuitResponse circuit, ArrayList<ResultsResponse> results) {
